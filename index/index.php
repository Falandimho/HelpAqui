...
<body>
	...
	<header id="menu">
		...
		<span>
			<a href="cadastro-login/tela-login.php">
	...
	<!-- conteudo !-->
	<div class="meia-lua">
		<h1 class="texto_fundo"> DESCUBRA A CARREIRA QUE SE ENCAIXA <br> MELHOR COM VOCÊ </h1>
		<a href="cadastro-login/fazercad.html" style="width: fit-content;"> <button class="botao-teste"> Faça seu teste </button> </a>
	</div>
	...
	<div id="passo_passo" class="shapedividers_com-8298">
		...
		<!-- <div class="bolas" style="top: 2.4em;"> <b>1º</b> </div> -->
		<div class="linhas">
			<!--<img src="../imagens/escrita.png" class="imagem-linha">-->
			<p class="texto_linhas1"> Faça o cadastro em nosso site </p>
			<p class="texto_linha"> Cadastre-se para realizar o teste vocacional. </p>
		</div>
		<!-- <div class="bolas" style="top:4.25em"> <b>2º</b> </div> -->
		<div class="linhas">
			<!-- <img src="../imagens/lista.png" class="imagem-linha">-->
		...
		<!-- <div class="bolas" style="top:6.2em"> <b>3º</b> </div> -->
		<div class="linhas">
			<!-- <img src="../imagens/pesquisar.png" class="imagem-linha"> -->
