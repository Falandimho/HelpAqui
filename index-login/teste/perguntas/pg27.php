...
<body>
		<div id="perguntas">
			...
			<h1>Eu acho muito interessante a criação de robôs e objetos automatizados, e gostaria de aprender mais sobre.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg27" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg27" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg27" id="triste" />
					<label for="triste">
