...
<body>
		<div id="perguntas">
			...
			<h1>Eu gosto de trabalhar sozinho e sem alguém em cima de mim me dizendo o que fazer e quando fazer.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg16" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg16" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg16" id="triste" />
					<label for="triste">
