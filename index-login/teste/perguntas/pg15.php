...
<body>
		<div id="perguntas">
			...
			<h1>Eu costumo manter minhas coisas em ordem e administrar meus gastos de maneira consciente.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg15" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg15" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg15" id="triste" />
					<label for="triste">
