...
<body>
		<div id="perguntas">
			...
			<h1>Eu gosto bastante de concertar as coisas de casa e me divirto descobrindo como elas funcionam.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg11" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg11" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg11" id="triste" />
					<label for="triste">
