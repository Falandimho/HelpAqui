...
<body>
			<div id="perguntas">
				...
				<h1>Eu gostaria de criar algo que a humanidade prosperaria com isso.</h1>

				<div id="respostas">
					<form method="post" id="form" action="attr-var.php">
						<input type="radio" value="1" name="pg18" id="feliz" />
						<label for="feliz">
						...
						<input type="radio" value="2" name="pg18" id="neutro" />
						<label for="neutro">
						...
						<input type="radio" value="3" name="pg18" id="triste" />
						<label for="triste">
