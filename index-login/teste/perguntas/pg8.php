...
<html lang="pt-br">
	...
	<body>
		<div id="perguntas">
			...
			<h1>Na escola eu me destaco por ser um aluno que tira notas medianas em tudo, menos educação física.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg8" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg8" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg8" id="triste"/>
					<label for="triste">
