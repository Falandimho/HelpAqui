...
<body>
		<div id="perguntas">
			...
			<h1>Eu particularmente adoraria cooperar com uma empresa transportadora e trabalhar em equipe.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg30" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg30" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg30" id="triste" />
					<label for="triste">
