...
<body>
		<div id="perguntas">
			...
			<h1>Eu gosto bastante de ler e escrever, e faço isso muito bem.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg20" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg20" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg20" id="triste" />
					<label for="triste">
