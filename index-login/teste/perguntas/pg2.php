...
<body>
	<div id="perguntas">
		<span id="progresso">
			...
			<h1>Se eu fosse criar uma empresa hoje, essa empresa seria criativa, onde eu pudesse arriscar e desenvolver novas ideias.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg2" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg2" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg2" id="triste"/>
					<label for="triste">
