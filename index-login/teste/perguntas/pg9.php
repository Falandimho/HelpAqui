...
<html lang="pt-br">
	...
	<body>
		<div id="perguntas">
			...
			<h1>Eu me sinto bem trabalhando em equipe e mantendo a ordem na mesma.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg9" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg9" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg9" id="triste"/>
					<label for="triste">
