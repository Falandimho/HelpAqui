...
<body>
	<div id="perguntas">
		<span id="progresso">
			...
			<p>3 de 30</p>
			<h1>Eu me considero uma pessoa mais extrovertida do que introvertida.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
				<input type="radio" value="1" name="pg3" id="feliz"/>
				<label for="feliz">
				...
				<input type="radio" value="2" name="pg3" id="neutro"/> 
				<label for="neutro">
				...
				<input type="radio" value="3" name="pg3" id="triste"/>
				<label for="triste">
