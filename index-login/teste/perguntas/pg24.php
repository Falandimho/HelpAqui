...
<body>
		<div id="perguntas">
			...
			<h1>Eu sou muito bom nas disciplinas de exatas.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg24" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg24" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg24" id="triste" />
					<label for="triste">
