...
<body>
			<div id="perguntas">
				...
				<h1>Eu costumo julgar as pessoas pelos seus trejeitos e postura diante da sociedade.</h1>

				<div id="respostas">
					<form method="post" id="form" action="attr-var.php">
						<input type="radio" value="1" name="pg19" id="feliz" />
						<label for="feliz">
						...
						<input type="radio" value="2" name="pg19" id="neutro" />
						<label for="neutro">
						...
						<input type="radio" value="3" name="pg19" id="triste" />
						<label for="triste">
