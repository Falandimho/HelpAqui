...
<body>
	<div id="perguntas">
		<span id="progresso">
			...
			<h1>Em um ambiente onde eu não conheço ninguém eu costumo ficar quieto em um canto.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg4" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg4" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg4" id="triste"/>
					<label for="triste">
