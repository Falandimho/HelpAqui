...
<body>
		<div id="perguntas">
			...
			<h1>Eu gosto de trabalhar em equipe para cooperar com o projeto de forma saúdavel e divertida.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg22" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg22" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg22" id="triste" />
					<label for="triste">
