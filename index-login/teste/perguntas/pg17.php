...
<body>
		<div id="perguntas">
			...
			<h1>Eu sou uma pessoa muito energética e gosto de praticar exercícios físicos.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg17" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg17" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg17" id="triste" />
					<label for="triste">
