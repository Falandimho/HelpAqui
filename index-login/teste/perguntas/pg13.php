...
<body>
		<div id="perguntas">
			...
			<h1>Eu costumo sempre cuidar do bem estar dos meus familiares e amigos.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg13" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg13" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg13" id="triste" />
					<label for="triste">
