...
<html lang="pt-br">
	...
	<body>
		<div id="perguntas">
			...
			<h1>Eu costumo me cobrar bastante e manter a responsabilidade sempre, exijo isso dos meus amigos também.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg6" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg6" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg6" id="triste"/>
					<label for="triste">
