...
<body>
		<div id="perguntas">
			...
			<h1>Eu prefiro trabalhar em casa, fazendo meu próprio horário, do que em uma empresa trabalhando presencialmente.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg26" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg26" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg26" id="triste" />
					<label for="triste">
