...
<body>
			<div id="perguntas">
				...
				<h1>Eu adoro estar sempre por dentro das notícas e acontecimentos do mundo.</h1>

				<div id="respostas">
					<form method="post" id="form" action="attr-var.php">
						<input type="radio" value="1" name="pg29" id="feliz" />
						<label for="feliz">
						...
						<input type="radio" value="2" name="pg29" id="neutro" />
						<label for="neutro">
						...
						<input type="radio" value="3" name="pg29" id="triste" />
						<label for="triste">
