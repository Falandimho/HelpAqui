...
<body>
		<div id="perguntas">
			...
			<h1>Eu costumo expressar meus sentimentos nas coisas que faço.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg21" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg21" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg21" id="triste" />
					<label for="triste">
