...
<html lang="pt-br">
	...
	<body>
		<div id="perguntas">
			...
			<h1>Eu gosto de desenhar e costumo ter ideias criativas para meus desenhos e projetos.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg10" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg10" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg10" id="triste"/>
					<label for="triste">
