...
<body>
			<div id="perguntas">
				...
				<h1>Eu procuro me relacionar com pessoas com interesses diferentes do meu, por que gosto de conhecer coisas novas.</h1>

				<div id="respostas">
					<form method="post" id="form" action="attr-var.php">
						<input type="radio" value="1" name="pg28" id="feliz" />
						<label for="feliz">
						...
						<input type="radio" value="2" name="pg28" id="neutro" />
						<label for="neutro">
						...
						<input type="radio" value="3" name="pg28" id="triste" />
						<label for="triste">
