...
<html lang="pt-br">
	...
	<body>
		<div id="perguntas">
			...
			<h1>Eu gostaria muito de trabalhar com algo direcionado aos esportes.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg5" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg5" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg5" id="triste"/>
					<label for="triste">
