...
<html lang="pt-br">
	...
	<body>
		<div id="perguntas">
			...
			<h1>Eu sou muito bom em realizar cálculos matemáticos e não costumo ter nenhum problema com isso.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg7" id="feliz"/>
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg7" id="neutro"/> 
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg7" id="triste"/>
					<label for="triste">
