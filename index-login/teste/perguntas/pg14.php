...
<body>
		<div id="perguntas">
			...
			<h1>Eu prefiro resolver cáculos matemáticos no papel para entender melhor.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg14" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg14" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg14" id="triste" />
					<label for="triste">
