...
<body>
		<div id="perguntas">
			...
			<h1>Eu gosto de sempre registrar meus compromissos para não esquecer e mantenho minha rotina em ordem.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg23" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg23" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg23" id="triste" />
					<label for="triste">
