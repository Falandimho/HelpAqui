...
<body>
		<div id="perguntas">
			...
			<h1>Eu costumo ter uma visão de negócios, ou seja, como atuar em diferentes situações de forma eficiente.</h1>

			<div id="respostas">
				<form method="post" id="form" action="attr-var.php">
					<input type="radio" value="1" name="pg25" id="feliz" />
					<label for="feliz">
					...
					<input type="radio" value="2" name="pg25" id="neutro" />
					<label for="neutro">
					...
					<input type="radio" value="3" name="pg25" id="triste" />
					<label for="triste">
