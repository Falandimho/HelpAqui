...
<body>
	...
	<ul class="menu">
		...
		<li><a class="tab3"> Profissional de tecnologia da informação </a></li>
		<li><a class="tab4"> Atleta </a></li>
	...
	<article>
		<div id="area">
			<div id="tab1">
				<h2> Engenharia </h2>
				<form method="post">
					<a href="https://querobolsa.com.br/cursos-e-faculdades/engenharia-civil"> Engenharia civil </a>
					<b> Duração: </b> em média, 5 anos.<br>
					<label for="fav1">
						<img class="fav" src="../../imagens/icones/fav.png">
					</label>

					<a href="https://querobolsa.com.br/cursos-e-faculdades/engenharia-eletrica"> Engenharia elétrica </a>
					<b> Duração: </b> em média, 5 anos.<br>
					<label for="fav2">
						<img class="fav" src="../../imagens/icones/fav.png">
					</label>

					<a href="https://querobolsa.com.br/cursos-e-faculdades/engenharia-de-computacao"> Engenharia da computação </a>
					<b> Duração: </b> em média, 5 anos.<br>
					<label for="fav3">
						<img class="fav" src="../../imagens/icones/fav.png">
					</label>

					<a href="https://querobolsa.com.br/cursos-e-faculdades/engenharia-de-producao"> Engenharia de produção </a>
					<b> Duração: </b> em média, 5 anos.<br>
					<label for="fav4">
						<img class="fav" src="../../imagens/icones/fav.png">
					</label>

					<a href="https://querobolsa.com.br/cursos-e-faculdades/engenharia-de-alimentos"> Engenharia de alimentos </a>
					<b> Duração: </b> em média, 5 anos.<br>
					<label for="fav5">
						<img class="fav" src="../../imagens/icones/fav.png">
					</label>

					<a href="https://querobolsa.com.br/cursos-e-faculdades/engenharia-mecanica"> Engenharia mecânica </a>
					<b> Duração: </b> em média, 5 anos.<br>
					<label for="fav6">
						<img class="fav" src="../../imagens/icones/fav.png">
					</label>
